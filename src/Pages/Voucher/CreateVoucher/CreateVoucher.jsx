  ...
  return (
    <div className={styles.MainContainer}>
      ...
      <div className={styles.btn}>
        {/* <Button colorScheme='black' variant='outline' w="127px"  onClick={() => setCreate(false)}>Cancel</Button> */}
        <Button colorScheme='black' variant='outline' w="127px"  onClick={() => navigate("/Voucher")}>Cancel</Button>
