...
const Upcoming = ({ notification ,type, page, total, setpage, loading, upcomingTotal}) => {
                            ...
                            <Tr key={i}>
                                ...
                                <Td>
                                    <div className={styles.actionDiv}>
                                        <ChangeDate notificationId={el._id} releaseDate={el.releaseDate} releaseTime={el.releaseTime} type={type} page={page}/>
                                        <span className={styles.blackBtn3} onClick={()=> handleDelete(el._id)}><RxCrossCircled fontSize={20} /> Delete</span>
                                    </div>
                                </Td>
                            </Tr>
