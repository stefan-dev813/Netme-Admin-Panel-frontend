...
function ViewAdExternalAds() {
  ...
  useEffect(() => {
    const fetchSingleAd = async () => {
      try {
        const response = await userRequest.get(`/admin/partner/getSingleExternalAds?_id=${id}`);
...
export default ViewAdExternalAds;
