    ...
    if (!form.planName) {
      ...
      if (!form.timePeriod) {
        ...
        if (!form.price) {
          ...
          dispatch(updateSubscriptionData({ ...form, planId: form._id, userType: "USER" })).then((res) => {
            navigate("/SubscriptionUser")
  ...
  return (
    <div className={styles.MainContainer}>
      ...
      <div className={styles.btn}>
        <Button colorScheme='black' variant='outline' onClick={() => navigate("/SubscriptionUser")}>Cancel</Button>
        <Button bg="black" color="#fff" variant='solid' onClick={UpdateData}>Save</Button>
      </div>
    </div>
  )
}
